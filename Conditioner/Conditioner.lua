...
function ConditionerAddOn:ConvertFromMask(charSet, tab)
    local first, second =
        (#charSet < 2) and "0" or charSet:sub(1, 1),
...
function ConditionerAddOn:GetNextPriorityButton()
    ...
    local myParent =
        (#ConditionerAddOn.PriorityButtons > 0) and ConditionerAddOn.PriorityButtons[#ConditionerAddOn.PriorityButtons] or
...
function ConditionerAddOn:UpdateCastBar(elapsed)
    if
        (ConditionerAddOn_SavedVariables.Options.ShowTargetCastBar or ConditionerAddOn.ShowCastBar) and
            (not UnitHasVehicleUI("player"))
     then
        if
            (ConditionerAddOn.TrackedFrameDragAnchor.CastingBar) and (ConditionerAddOn.TrackingFrames) and
                (ConditionerAddOn.TrackingFrames[1]) and
                (ConditionerAddOn.TrackingFrames[1]:IsShown())
         then
            ...
            ConditionerAddOn.TrackedFrameDragAnchor.CastingBar.Text:SetFont(
                "Fonts\\FRIZQT__.TTF",
                math.ceil(0.5 * mainTrackedFrame:GetHeight() / 5),
                "OUTLINE, NORMAL"
            )
            ...
            if (texture) then
                ...
                ConditionerAddOn.TrackedFrameDragAnchor.CastingBar.Background:SetWidth(
                    mainTrackedFrame:GetWidth() - ConditionerAddOn.TrackedFrameDragAnchor.CastingBar:GetWidth()
                )
                ...
                if (ConditionerAddOn.ShowCastBar) then
                    ...
                    ConditionerAddOn.TrackedFrameDragAnchor.CastingBar.Timer:SetPoint(
                        "CENTER",
                        mainTrackedFrame,
                        "CENTER"
                    )
                    ConditionerAddOn.TrackedFrameDragAnchor.CastingBar.Timer:SetText(convertedTime)
                    ConditionerAddOn.TrackedFrameDragAnchor.CastingBar.Timer:SetFont(
                        "Fonts\\FRIZQT__.TTF",
                        math.ceil(mainTrackedFrame:GetHeight() / 3),
                        "OUTLINE, NORMAL"
                    )
...
function ConditionerAddOn:OnUpdate(elapsed)
    ...
    if
        (ConditionerAddOn_SavedVariables.Options.OnlyDisplayInCombat) and (not SpellBookFrame:IsShown()) and
            (not UnitAffectingCombat("player")) or
            ...
            if (k == 1) and (ConditionerAddOn.TrackedFrameDragAnchor.MainHand) then
                ...
                if (ConditionerAddOn_SavedVariables.Options.AnchorDirection == 3) then
                    if (ConditionerAddOn.TrackedFrameDragAnchor.OffHand:IsShown()) then
                        ConditionerAddOn.TrackedFrameDragAnchor.OffHand:SetPoint(
                            "BOTTOMLEFT",
                            newTrackerFrame,
                            "TOPLEFT"
                        )
                        ConditionerAddOn.TrackedFrameDragAnchor.MainHand:SetPoint(
                            "BOTTOMLEFT",
                    ...
                    if (ConditionerAddOn.TrackedFrameDragAnchor.MainHand:IsShown()) then
                        ConditionerAddOn.TrackedFrameDragAnchor.CastingBar:SetPoint(
                            "BOTTOMLEFT",
                            ConditionerAddOn.TrackedFrameDragAnchor.MainHand,
                            "TOPLEFT"
                        )
                    else
                        ConditionerAddOn.TrackedFrameDragAnchor.CastingBar:SetPoint(
                ...
                elseif
                    (ConditionerAddOn_SavedVariables.Options.AnchorDirection == 0 or
                        ConditionerAddOn_SavedVariables.Options.AnchorDirection == 2)
                 then
                    ConditionerAddOn.TrackedFrameDragAnchor.CastingBar:SetPoint(
                        "BOTTOMLEFT",
                        newTrackerFrame,
                    ...
                    if (ConditionerAddOn.TrackedFrameDragAnchor.CastingBar:IsShown()) then
                        ConditionerAddOn.TrackedFrameDragAnchor.MainHand:SetPoint(
                            "TOPLEFT",
                            ConditionerAddOn.TrackedFrameDragAnchor.CastingBar,
                            "BOTTOMLEFT"
                        )
                    else
                        ConditionerAddOn.TrackedFrameDragAnchor.MainHand:SetPoint(
...
function ConditionerAddOn:UpdateSwingTimers(elapsed)
    ...
    if
        (UnitHasVehicleUI("player")) or (InCinematic()) or (not parent) or (not parent:IsShown()) or
            ((ConditionerAddOn_SavedVariables.Options.OnlyDisplayInCombat) and (not SpellBookFrame:IsShown()) and
    ...
    if (ConditionerAddOn_SavedVariables.Options.ShowSwingTimers) then
        if (ConditionerAddOn.TrackedFrameDragAnchor.MainHand) then
            ...
            ConditionerAddOn.TrackedFrameDragAnchor.MainHand.Text:SetFont(
                "Fonts\\FRIZQT__.TTF",
                math.ceil(0.6 * h),
                "OUTLINE, NORMAL"
            )
            ConditionerAddOn.TrackedFrameDragAnchor.OffHand.Text:SetFont(
                "Fonts\\FRIZQT__.TTF",
                math.ceil(0.6 * h),
                "OUTLINE, NORMAL"
            )
...
function ConditionerAddOn:SpellCacheTraverse(prefix, i, node, properPrefix)
    if (i <= #prefix) then
        ...
        if (node.children) and (index) then
            ...
            if (child) then
                return ConditionerAddOn:SpellCacheTraverse(
                    prefix,
                    i + 1,
                    child,
...
function ConditionerAddOn:GetConditions(frame)
    ...
    local boolString =
        ConditionerAddOn:EncodeToMask(
        {
            frame.Conditions.secondsRemainingBool,
    ...
    local boolStringShort =
        ConditionerAddOn:EncodeToMask(
        {
            frame.Conditions.cooldownRemainingIsItemID,
    ...
    local encoded_alternateResourceTypeEnum =
        ConditionerAddOn:EncodeToMask(frame.Conditions.alternateResourceTypeEnum, true)
    local encoded_alternateResourceConditionalEnum =
        ConditionerAddOn:EncodeToMask(frame.Conditions.alternateResourceConditionalEnum, true)
...
function ConditionerAddOn:NewInputBox(parent, key, numbersOnly)
    ...
    o:SetScript(
        ...
        function(self, button)
            ...
            if
                (ConditionerAddOn.SharedConditionerFrame.DispelFilterButton) and
    ...
    o:SetScript(
        ...
        function(self)
            ...
            if
                (ConditionerAddOn.SharedConditionerFrame.ResultsBox) and
                    (ConditionerAddOn.SharedConditionerFrame.ResultsBox:IsShown())
             then
...
function ConditionerAddOn:CheckCondition(priorityButton)
    local spellID, itemID, Conditions =
        priorityButton.Data.spellID,
        priorityButton.Data.itemID,
    ...
    elseif
        (targetUnitEnum == 2 or targetUnitEnum == 3 or targetUnitEnum == 4 or targetUnitEnum == 13 or
            targetUnitEnum == 14 or
            targetUnitEnum == 15)
     then
    ...
    -- 2/5 enemy
    if
        (targetUnitEnum == 2 or targetUnitEnum == 5 or targetUnitEnum == 14) and
            (not UnitCanAttack("player", targetUnitToken))
     then
    ...
    -- 3/6 friend
    if
        (targetUnitEnum == 3 or targetUnitEnum == 6 or targetUnitEnum == 13) and
            (UnitCanAttack("player", targetUnitToken))
     then
    ...
    if (Conditions.resourceTypeEnum > 0) then
        ...
        elseif (Conditions.resourceTypeEnum == 6) then
            ...
            leftValue =
                UnitPower("player", Conditions.resourceTypeEnum - 1) /
    ...
    if (Conditions.alternateResourceTypeEnum > 0) then
        ...
        elseif (Conditions.alternateResourceTypeEnum == 6) then
            ...
            leftValue =
                UnitPower("player", Conditions.alternateResourceTypeEnum - 1) /
                ((usePercentage) and UnitPowerMax("player", Conditions.alternateResourceTypeEnum - 1) or 1)
        end
        leftValue = (usePercentage) and (leftValue * 100) or leftValue
        local satisfied =
            ConditionerAddOn:CompareValues(leftValue, Conditions.alternateResourceConditionalEnum, rightValue)
        if (not satisfied) then
...
function ConditionerAddOn:GetAvailableTrackingFrame()
    ...
    trackingFrame.parentNode =
        (#ConditionerAddOn.TrackingFrames > 0) and ConditionerAddOn.TrackingFrames[#ConditionerAddOn.TrackingFrames] or
    ...
    trackingFrame.Countdown.Text:SetFont(
        "Fonts\\FRIZQT__.TTF",
        math.ceil(0.24 * ConditionerAddOn_SavedVariables.Options.TrackedFrameSize * mult),
        "OUTLINE, THICK"
    )
...
function ConditionerAddOn:NewCheckBox(parent, label, key)
    ...
    o:SetScript(
        ...
        function(self, ...)
            ...
            if
                (not self.filter) and (ConditionerAddOn.SharedConditionerFrame.DispelFilterButton) and
                    (ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Anchor)
             then
                ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Anchor:Hide()
            end
...
function ConditionerAddOn:NewConditionsWindow(parent)
    ...
    o:SetScript(
        ...
        function(self)
            ...
            ConditionerAddOn.SharedConditionerFrame:SetClampRectInsets(
                0,
                0,
                0,
        ...
        function(self)
            ...
            if (o.Data) then
                ...
                GameTooltip:AddLine(
                    string.format(
                        "\n%s : %s",
                        (o.Data.itemID ~= 0) and "Item ID" or "Spell ID",
                        (o.Data.itemID ~= 0) and o.Data.itemID or o.Data.spellID
                    ),
                    0,
                    0.75,
                    1,
                ...
                GameTooltip:AddLine(
                    string.format("Right Click - Remove %s From List", (o.Data.itemID ~= 0) and "Item" or "Spell"),
                    1,
                    0.4,
                    1,
                    true
    ...
    if (loadoutID) then
        ...
        if (loadoutID == -1) then
            ...
            if (currentSpecID) then
                local currentSpec = GetSpecializationInfo(currentSpecID)
                if
                    (ConditionerAddOn_SavedVariables_Loadouts[loadoutID]) and
                        (ConditionerAddOn_SavedVariables_Loadouts[loadoutID].spec == currentSpec)
                 then
        ...
        if (currentSpecID) then
            ...
            if (packageID) then
                if (packageID == -1) then
                    ...
                    if
                        (ConditionerAddOn_SavedVariables_Loadouts[packageID]) and
                            (ConditionerAddOn_SavedVariables_Loadouts[packageID].spec == currentSpec)
                     then
...
function ConditionerAddOn:Init()
    ...
    ConditionerAddOn.HighlightDemoButton:SetScript(
        "OnUpdate",
    ...
    ConditionerAddOn.TrackedFrameDragAnchor.x =
        ConditionerAddOn_SavedVariables.Options.TrackedFrameAnchorCoords.x or UIParent:GetWidth() / 2
    ConditionerAddOn.TrackedFrameDragAnchor.y =
        ConditionerAddOn_SavedVariables.Options.TrackedFrameAnchorCoords.y or UIParent:GetHeight() / 2
    ConditionerAddOn.TrackedFrameDragAnchor:SetFrameStrata("HIGH")
    ConditionerAddOn.TrackedFrameDragAnchor:SetPoint(
        "CENTER",
        UIParent,
        "BOTTOMLEFT",
        ConditionerAddOn.TrackedFrameDragAnchor.x,
    ...
    SetPortraitToTexture(
        ConditionerAddOn.TrackedFrameDragAnchor.Texture,
        "Interface\\DialogFrame\\UI-DialogBox-Background"
    )
    ConditionerAddOn.TrackedFrameDragAnchor.Text =
        ConditionerAddOn.TrackedFrameDragAnchor:CreateFontString(nil, "OVERLAY", "SystemFont_NamePlateCastBar")
    ...
    ConditionerAddOn.TrackedFrameDragAnchor:SetScript(
        "OnDragStart",
        function(self)
            self:StartMoving()
        end
    ...
    ConditionerAddOn.TrackedFrameDragAnchor:SetScript(
        ...
        function(self)
            ...
            GameTooltip:SetText("Conditioner", 0, 0.75, 1)
            GameTooltip:AddLine(
                "Left Click - Drag Anchor\nRight Click - Rotate Tail\nMouse Wheel - Resize Frames",
                1,
                1,
                1,
                true
    ...
    ConditionerAddOn.TrackedFrameDragAnchor:SetScript(
        ...
        function(self, delta)
            ConditionerAddOn_SavedVariables.Options.TrackedFrameSize =
                math.max(
                50,
                math.min((ConditionerAddOn_SavedVariables.Options.TrackedFrameSize or 100) + delta * 20, 300)
            )
            ConditionerAddOn:ResizeTrackers()
        end
    )
    ...
    ConditionerAddOn.TrackedFrameDragAnchor.MainHand =
        ConditionerAddOn:CreateSwingFrame("Main Hand", UIParent, 0, 0.75, 1)
    ConditionerAddOn.TrackedFrameDragAnchor.OffHand =
        ConditionerAddOn:CreateSwingFrame("Off Hand", ConditionerAddOn.TrackedFrameDragAnchor.MainHand, 1, 0, 1)
    ...
    ConditionerAddOn.TrackedFrameDragAnchor.CastingBar =
        ConditionerAddOn:CreateSwingFrame("CASTBAR", UIParent, 1, 1, 0.25)
    ...
    ConditionerAddOn.SharedConditionerFrame.Background =
        CreateFrame("Frame", nil, ConditionerAddOn.SharedConditionerFrame)
    ...
    ConditionerAddOn.SharedConditionerFrame.Background:SetScript(
        "OnShow",
        function(self)
            C_Timer.After(
                0.01,
                function()
                    ...
                    if
                        (leftA) and (leftB) and (leftA <= (leftB + widthB)) and (leftB <= (leftA + widthA)) and
                            (bottomA <= (bottomB + heightB)) and
                            (bottomB <= (bottomA + heightA))
                     then
    ...
    ConditionerAddOn.SharedConditionerFrame.DropDowns[5] =
        ConditionerAddOn:NewDropDown(
        "Target Unit",
        "ConditionerAuraTargetDropDown",
        ConditionerAddOn.SharedConditionerFrame,
        150,
        ConditionerAddOn.Enums.auraTargetChoicesEnum,
        "auraTargetEnum"
    )
    ConditionerAddOn.SharedConditionerFrame.DropDowns[5]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame,
        "TOPRIGHT"
    )

    ConditionerAddOn.SharedConditionerFrame.Background:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[5],
        "TOPLEFT",
        4,
    ...
    --explain
    ConditionerAddOn.SharedConditionerFrame.Background.InfoButton =
        CreateFrame("Button", nil, ConditionerAddOn.SharedConditionerFrame.Background, "UIPanelInfoButton")
    ConditionerAddOn.SharedConditionerFrame.Background.InfoButton:SetPoint(
        "CENTER",
        ConditionerAddOn.SharedConditionerFrame.Background,
        "TOPRIGHT"
    )
    ConditionerAddOn.SharedConditionerFrame.Background.InfoButton:SetScript(
        "OnEnter",
        function(self)
    ...
    ConditionerAddOn.SharedConditionerFrame.DropDowns[6] =
        ConditionerAddOn:NewDropDown(
        "Required Shapeshift Form",
        "ConditionerShapeShiftDropDown",
        ConditionerAddOn.SharedConditionerFrame,
        150,
        ConditionerAddOn.Enums.shapeShiftChoicesEnum,
        "shapeShiftEnum"
    )
    ConditionerAddOn.SharedConditionerFrame.DropDowns[6]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[5],
        "BOTTOMLEFT",
        0,
    ...
    --resource type 1
    ConditionerAddOn.SharedConditionerFrame.DropDowns[1] =
        ConditionerAddOn:NewDropDown(
        "Resource Type",
        "ConditionerResourceDropDown",
        ConditionerAddOn.SharedConditionerFrame,
        150,
        ConditionerAddOn.Enums.resourceEnum,
        "resourceTypeEnum"
    )
    ConditionerAddOn.SharedConditionerFrame.DropDowns[1]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[6],
        "BOTTOMLEFT",
        0,
    ...
    ConditionerAddOn.SharedConditionerFrame.DropDowns[2] =
        ConditionerAddOn:NewDropDown(
        nil,
        "ConditionerResourceDropDownOperator",
        ConditionerAddOn.SharedConditionerFrame,
        75,
        ConditionerAddOn.Enums.conditionalOperatorEnum,
        "resourceConditionalEnum"
    )
    ConditionerAddOn.SharedConditionerFrame.DropDowns[2]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[1],
        "BOTTOMLEFT"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[1] =
        ConditionerAddOn:NewInputBox(ConditionerAddOn.SharedConditionerFrame, "resourceAmount", true)
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[1]:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[2],
        "RIGHT"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[1] =
        ConditionerAddOn:NewCheckBox(ConditionerAddOn.SharedConditionerFrame, "%", "resourceUsePercentageBool")
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[1].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[1],
        "RIGHT"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[1]:SetPoint(
        "TOPRIGHT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[1],
        "BOTTOMRIGHT",
        -12,
    ...
    --resource type 2
    ConditionerAddOn.SharedConditionerFrame.DropDowns[3] =
        ConditionerAddOn:NewDropDown(
        "Resource Type",
        "ConditionerAltResourceDropDown",
        ConditionerAddOn.SharedConditionerFrame,
        150,
        ConditionerAddOn.Enums.resourceEnum,
        "alternateResourceTypeEnum"
    )
    ConditionerAddOn.SharedConditionerFrame.DropDowns[3]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[1],
        "TOPRIGHT"
    )
    --resource Conditional 2
    ConditionerAddOn.SharedConditionerFrame.DropDowns[4] =
        ConditionerAddOn:NewDropDown(
        nil,
        "ConditionerAltResourceDropDownOperator",
        ConditionerAddOn.SharedConditionerFrame,
        75,
        ConditionerAddOn.Enums.conditionalOperatorEnum,
        "alternateResourceConditionalEnum"
    )
    ConditionerAddOn.SharedConditionerFrame.DropDowns[4]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[3],
        "BOTTOMLEFT"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[2] =
        ConditionerAddOn:NewInputBox(ConditionerAddOn.SharedConditionerFrame, "alternateResourceAmount", true)
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[2]:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[4],
        "RIGHT"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[2] =
        ConditionerAddOn:NewCheckBox(ConditionerAddOn.SharedConditionerFrame, "%", "alternateResourceUsePercentageBool")
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[2].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[2],
        "RIGHT"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[2]:SetPoint(
        "TOPRIGHT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[3],
        "BOTTOMRIGHT",
        -12,
    ...
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[3].text =
        ConditionerAddOn.SharedConditionerFrame.EditBoxes[3]:CreateFontString(
        nil,
        "OVERLAY",
    ...
    ConditionerAddOn.SharedConditionerFrame.ResultsBox:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.EditBoxes[3],
        "BOTTOMLEFT"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[3]:SetScript(
        "OnTextChanged",
    ...
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[4] =
        ConditionerAddOn:NewInputBox(ConditionerAddOn.SharedConditionerFrame, "keyBindingString")
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[4]:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[6],
        "RIGHT"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[4].text =
        ConditionerAddOn.SharedConditionerFrame.EditBoxes[4]:CreateFontString(
        nil,
        "OVERLAY",
        "SystemFont_NamePlateCastBar"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.DropDowns[7] =
        ConditionerAddOn:NewDropDown(
        nil,
        "ConditionerStacksDropDown",
        ConditionerAddOn.SharedConditionerFrame,
        75,
        ConditionerAddOn.Enums.conditionalOperatorEnum,
        "stackConditionalEnum"
    )
    ConditionerAddOn.SharedConditionerFrame.DropDowns[7]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[2],
        "BOTTOMLEFT",
        0,
    ...
    --stacks amount
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[5] =
        ConditionerAddOn:NewInputBox(ConditionerAddOn.SharedConditionerFrame, "stacksAmount", true)
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[5]:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[7],
        "RIGHT"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[5].text =
        ConditionerAddOn.SharedConditionerFrame.EditBoxes[5]:CreateFontString(
        nil,
        "OVERLAY",
        "SystemFont_NamePlateCastBar"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.DropDowns[8] =
        ConditionerAddOn:NewDropDown(
        nil,
        "ConditionerChargesDropDown",
        ConditionerAddOn.SharedConditionerFrame,
        75,
        ConditionerAddOn.Enums.conditionalOperatorEnum,
        "chargesConditionalEnum"
    )
    ConditionerAddOn.SharedConditionerFrame.DropDowns[8]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[4],
        "BOTTOMLEFT",
        0,
    ...
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[6] =
        ConditionerAddOn:NewInputBox(ConditionerAddOn.SharedConditionerFrame, "chargesAmount", true)
    ...
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[3] =
        ConditionerAddOn:NewCheckBox(
        ConditionerAddOn.SharedConditionerFrame,
        "Aura Seconds Remaining",
        "secondsRemainingBool"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[3].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[3],
        "RIGHT"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[3]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[7]:GetName() .. "Middle",
        "BOTTOMLEFT",
        -10,
        12
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[7] =
        ConditionerAddOn:NewInputBox(ConditionerAddOn.SharedConditionerFrame, "secondsRemainingAmount", true)
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[7]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[8]:GetName() .. "Middle",
        "BOTTOMLEFT",
        0,
        8
    )
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[7].text =
        ConditionerAddOn.SharedConditionerFrame.EditBoxes[7]:CreateFontString(
        nil,
        "OVERLAY",
        "SystemFont_NamePlateCastBar"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[4] =
        ConditionerAddOn:NewCheckBox(ConditionerAddOn.SharedConditionerFrame, "Requirements Met", "canCast")
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[4]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[3],
        "BOTTOMLEFT"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[4].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[4],
        "RIGHT"
    )
    ...
    --only when ready
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[5] =
        ConditionerAddOn:NewCheckBox(
        ConditionerAddOn.SharedConditionerFrame,
        "Only When Off Cooldown",
        "onlyWhenReadyBool"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[5]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[4],
        "BOTTOMLEFT"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[5].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[5],
        "RIGHT"
    )
    ...
    --highlight only
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[6] =
        ConditionerAddOn:NewCheckBox(
        ConditionerAddOn.SharedConditionerFrame,
        "Only When Highlighted",
        "highlightOnlyBool"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[6]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[5],
        "BOTTOMLEFT"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[6].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[6],
        "RIGHT"
    )
    ...
    --only in range
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[13] =
        ConditionerAddOn:NewCheckBox(ConditionerAddOn.SharedConditionerFrame, "Only Within Range", "onlyInRange")
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[13]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[6],
        "BOTTOMLEFT"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[13].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[13],
        "RIGHT"
    )
    ...
    --is interrupt
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[15] =
        ConditionerAddOn:NewCheckBox(ConditionerAddOn.SharedConditionerFrame, "Interrupt Spell", "isInterruptBool")
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[15]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[13],
        "BOTTOMLEFT"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[15].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[15],
        "RIGHT"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.DispelFilterButton =
        CreateFrame("Button", nil, ConditionerAddOn.SharedConditionerFrame, "ConditionerButtonTemplate")
    ConditionerAddOn.SharedConditionerFrame.DispelFilterButton:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.EditBoxes[7].Left,
        "BOTTOMLEFT",
        -4,
        -6
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Anchor =
        CreateFrame("Frame", nil, ConditionerAddOn.SharedConditionerFrame.DispelFilterButton)
    ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Anchor:Hide()
    ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Anchor:SetSize(10, 10)
    ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Anchor:SetPoint(
        "CENTER",
        ConditionerAddOn.SharedConditionerFrame.DispelFilterButton,
        "TOPRIGHT"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Menu =
        CreateFrame("Frame", nil, ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Anchor)
    ...
    ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Menu:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Anchor,
        "CENTER"
    )
    ...
    --debuff
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[7] =
        ConditionerAddOn:NewCheckBox(
        ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Anchor,
        "Debuff",
        "debuffBool"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[7].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[7],
        "RIGHT"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[7]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Anchor,
        "CENTER"
    )
    ...
    --buff
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[8] =
        ConditionerAddOn:NewCheckBox(
        ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Anchor,
        "Buff",
        "buffBool"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[8].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[8],
        "RIGHT"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[8]:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[7].text,
        "RIGHT"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[8].filter = true

    --magic
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[9] =
        ConditionerAddOn:NewCheckBox(
        ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Anchor,
        "Magic",
        "magicBool"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[9].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[9],
        "RIGHT"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[9]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[8],
        "BOTTOMLEFT"
    )
    ...
    --curse
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[10] =
        ConditionerAddOn:NewCheckBox(
        ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Anchor,
        "Curse",
        "curseBool"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[10].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[10],
        "RIGHT"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[10]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[9],
        "BOTTOMLEFT"
    )
    ...
    --poison
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[11] =
        ConditionerAddOn:NewCheckBox(
        ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Anchor,
        "Poison",
        "poisonBool"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[11].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[11],
        "RIGHT"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[11]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[7],
        "BOTTOMLEFT"
    )
    ...
    --disease
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[12] =
        ConditionerAddOn:NewCheckBox(
        ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Anchor,
        "Disease",
        "diseaseBool"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[12].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[12],
        "RIGHT"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[12]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[11],
        "BOTTOMLEFT"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Menu:SetPoint(
        "RIGHT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[9].text,
        "RIGHT",
        6,
        0
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Menu.Banner =
        CreateFrame("Frame", nil, ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Menu)
    ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Menu.Banner:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Menu,
        "TOPLEFT"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.DispelFilterButton:SetScript(
        "OnEnter",
        function(self)
            GameTooltip:SetOwner(self, "ANCHOR_RIGHT", 0, 0)
            GameTooltip:SetText("Dispel Filter", 0, 0.75, 1)
            GameTooltip:AddLine(
                "Set any combination of buffs or debuffs with various dispel types to check on your Target Unit.",
                1,
                1,
                1,
                true
    ...
    ConditionerAddOn.MainButton:SetScript(
        "OnHide",
        function(self)
            ConditionerAddOn.SharedConditionerFrame:Hide()
            ConditionerAddOn.SharedConditionerFrame.DispelFilterButton.Anchor:Hide()
    ...
    ConditionerAddOn.SharedConditionerFrame.CooldownRemaining =
        CreateFrame("Button", nil, ConditionerAddOn.SharedConditionerFrame)
    ConditionerAddOn.SharedConditionerFrame.CooldownRemaining:RegisterForClicks("LeftButtonUp", "RightButtonUp")
    ConditionerAddOn.SharedConditionerFrame.CooldownRemaining:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.DispelFilterButton,
        "LEFT",
        4,
    ...
    function ConditionerAddOn.SharedConditionerFrame.CooldownRemaining:ShowTooltip()
        ...
        GameTooltip:AddLine(
            "Drag and place a spell or item here to track its remaining cooldown time in seconds.",
            1,
            1,
            1,
            true
        ...
        if
            (ConditionerAddOn.CurrentPriorityButton) and
         ...
         then
            ...
            local cooldownName =
                (isItem) and GetItemInfo(ConditionerAddOn.CurrentPriorityButton.Conditions.cooldownRemainingID) or
            ...
            GameTooltip:AddLine(
                string.format("Right Click - Stop Tracking %s's Cooldown", cooldownName),
                1,
                0.4,
                1,
                true
    ...
    function ConditionerAddOn.SharedConditionerFrame.CooldownRemaining:UpdateIcon()
        if (ConditionerAddOn.CurrentPriorityButton) then
            ...
            if (ConditionerAddOn.CurrentPriorityButton.Conditions.cooldownRemainingID > 0) then
                local cooldownTexture =
                    (isItem) and GetItemIcon(ConditionerAddOn.CurrentPriorityButton.Conditions.cooldownRemainingID) or
    ...
    ConditionerAddOn.SharedConditionerFrame.CooldownRemaining:SetScript(
        "OnEnter",
        function(self)
            self:ShowTooltip()
    ...
    ConditionerAddOn.SharedConditionerFrame.DropDowns[9] =
        ConditionerAddOn:NewDropDown(
        nil,
        "ConditionerCDRDropDown",
        ConditionerAddOn.SharedConditionerFrame,
        75,
        ConditionerAddOn.Enums.conditionalOperatorEnum,
        "cooldownRemainingEnum"
    )
    ConditionerAddOn.SharedConditionerFrame.DropDowns[9]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.CooldownRemaining,
        "BOTTOMLEFT",
        -20,
    ...
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[8] =
        ConditionerAddOn:NewInputBox(ConditionerAddOn.SharedConditionerFrame, "cooldownRemainingAmount", true)
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[8]:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.DropDowns[9],
        "RIGHT"
    )
    ConditionerAddOn.SharedConditionerFrame.EditBoxes[8].text =
        ConditionerAddOn.SharedConditionerFrame.EditBoxes[8]:CreateFontString(
        nil,
        "OVERLAY",
        "SystemFont_NamePlateCastBar"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.CooldownRemaining:SetScript(
        ...
        function(self, button, down)
            ...
            elseif (button == "LeftButton") then
                ...
                if (spellID) then
                    ConditionerAddOn.CurrentPriorityButton.Conditions.cooldownRemainingIsItemID =
                        (itemID > 0) and true or false
                    local newTexture = (itemID > 0) and GetItemIcon(itemID) or GetSpellTexture(spellID)
                    ConditionerAddOn.CurrentPriorityButton.Conditions.cooldownRemainingID =
                        ((itemID > 0) and itemID or spellID) or 0
    ...
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[14] =
        ConditionerAddOn:NewCheckBox(ConditionerAddOn.SharedConditionerFrame, "Only While Controlled", "onlyDuringCC")
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[14]:SetPoint(
        "BOTTOM",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[15],
        "BOTTOM"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[14].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[14],
        "RIGHT"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[16].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[16],
        "RIGHT"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[17] =
        ConditionerAddOn:NewCheckBox(ConditionerAddOn.SharedConditionerFrame, "Only While Moving", "onlyWhileMoving")
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[17]:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[15],
        "BOTTOMLEFT"
    )
    ConditionerAddOn.SharedConditionerFrame.CheckBoxes[17].text:SetPoint(
        "LEFT",
        ConditionerAddOn.SharedConditionerFrame.CheckBoxes[17],
        "RIGHT"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.Background.Title =
        ConditionerAddOn.SharedConditionerFrame.Background:CreateFontString(
        nil,
        "OVERLAY",
        "SystemFont_OutlineThick_Huge2"
    )
    ConditionerAddOn.SharedConditionerFrame.Background.Title:SetTextColor(0, 1, 1, 1)
    ConditionerAddOn.SharedConditionerFrame.Background.Title:SetPoint(
        "BOTTOM",
        ConditionerAddOn.SharedConditionerFrame.Background,
        "TOP"
    )
    ...
    ConditionerAddOn.SharedConditionerFrame.Background.Title.Texture =
        ConditionerAddOn.SharedConditionerFrame.Background:CreateTexture()
    ConditionerAddOn.SharedConditionerFrame.Background.Title.Texture:SetPoint(
        "BOTTOM",
        ConditionerAddOn.SharedConditionerFrame.Background,
        "TOP"
    )
    ...
    ConditionerAddOn.LoadoutFrame.MaskTexture:SetPoint(
        "CENTER",
        ConditionerAddOn.LoadoutFrame.DragTexture,
        "CENTER",
        52,
        -18
    )
    ...
    ConditionerAddOn.LoadoutFrame.InfoButton:SetScript(
        "OnEnter",
        function(self)
            GameTooltip:SetOwner(self, "ANCHOR_LEFT", 0, 0)
    ...
    ConditionerAddOn.LoadoutFrame:SetScript(
        "OnDragStart",
        function(self, button)
            self:StartMoving()
            for k, v in pairs(ConditionerAddOn.SharedConditionerFrame.EditBoxes) do
    ...
    ConditionerAddOn.LoadoutFrame.InputName =
        CreateFrame("EditBox", nil, ConditionerAddOn.LoadoutFrame, "InputBoxTemplate")
    ConditionerAddOn.LoadoutFrame.InputName:Hide()
    ...
    ConditionerAddOn.LoadoutFrame.InputName.Title =
        ConditionerAddOn.LoadoutFrame.InputName:CreateFontString(nil, "OVERLAY", "SystemFont_Huge1_Outline")
    ...
    ConditionerAddOn.LoadoutFrame.InputName:SetScript(
        "OnEnterPressed",
        function(self)
            self:ClearFocus()
        end
    ...
    ConditionerAddOn.LoadoutFrame.InputName:SetScript(
        ...
        function(self, button)
            ...
            local defaultCheck =
                (ConditionerAddOn.LoadoutFrame.DropDown.Choices) and
    ...
    ConditionerAddOn.LoadoutFrame.InputName.SubmitButton =
        CreateFrame("Button", nil, ConditionerAddOn.LoadoutFrame.InputName, "ConditionerButtonTemplate")
    ConditionerAddOn.LoadoutFrame.InputName.SubmitButton:SetText("Save")
    ConditionerAddOn.LoadoutFrame.InputName.SubmitButton:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.LoadoutFrame.InputName,
        "BOTTOMLEFT"
    )
    ...
    ConditionerAddOn.LoadoutFrame.InputName.SubmitButton:SetScript(
        "OnClick",
        function(self)
            PlaySound(1115)
    ...
    ConditionerAddOn.LoadoutFrame.InputName.CancelButton =
        CreateFrame("Button", nil, ConditionerAddOn.LoadoutFrame.InputName, "ConditionerButtonTemplate")
    ConditionerAddOn.LoadoutFrame.InputName.CancelButton:SetText("Cancel")
    ConditionerAddOn.LoadoutFrame.InputName.CancelButton:SetPoint(
        "TOPRIGHT",
        ConditionerAddOn.LoadoutFrame.InputName,
        "BOTTOMRIGHT"
    )
    ...
    ConditionerAddOn.LoadoutFrame.InputName.CancelButton:SetScript(
        "OnClick",
        function(self)
            PlaySound(1115)
            ConditionerAddOn.LoadoutFrame.InputName:Hide()
    ...
    ConditionerAddOn.LoadoutFrame.ImportExport.Background =
        CreateFrame("Frame", nil, ConditionerAddOn.LoadoutFrame.ImportExport)
    ConditionerAddOn.LoadoutFrame.ImportExport.Background:SetFrameStrata("BACKGROUND")
    ConditionerAddOn.LoadoutFrame.ImportExport.Background:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.LoadoutFrame.ImportExport,
        "TOPLEFT",
        -16,
    ...
    ConditionerAddOn.LoadoutFrame.ImportExport.CancelButton =
        CreateFrame("Button", nil, ConditionerAddOn.LoadoutFrame.ImportExport, "ConditionerButtonTemplate")
    ConditionerAddOn.LoadoutFrame.ImportExport.CancelButton:SetText("Close")
    ConditionerAddOn.LoadoutFrame.ImportExport.CancelButton:SetPoint(
        "TOPRIGHT",
        ConditionerAddOn.LoadoutFrame.ImportExport,
        "BOTTOMRIGHT"
    )
    ...
    ConditionerAddOn.LoadoutFrame.ImportExport.CancelButton:SetScript(
        "OnClick",
        function(self)
            PlaySound(1115)
            ConditionerAddOn.LoadoutFrame.ImportExport:Hide()
    ...
    ConditionerAddOn.LoadoutFrame.ImportExport.AcceptButton =
        CreateFrame("Button", nil, ConditionerAddOn.LoadoutFrame.ImportExport, "ConditionerButtonTemplate")
    ConditionerAddOn.LoadoutFrame.ImportExport.AcceptButton:SetText("Apply")
    ConditionerAddOn.LoadoutFrame.ImportExport.AcceptButton:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.LoadoutFrame.ImportExport,
        "BOTTOMLEFT"
    )
    ...
    ConditionerAddOn.LoadoutFrame.ImportExport.AcceptButton:SetScript(
        "OnClick",
        function(self)
            PlaySound(1115)
    ...
    ConditionerAddOn.LoadoutFrame.ImportExport:SetScript(
        "OnEnter",
        function(self)
            GameTooltip:SetOwner(self, "ANCHOR_RIGHT", 0, 0)
    ...
    ConditionerAddOn.LoadoutFrame.ImportExport.Message =
        ConditionerAddOn.LoadoutFrame.ImportExport:CreateFontString(nil, "OVERLAY", "SystemFont_Huge1_Outline")
    ConditionerAddOn.LoadoutFrame.ImportExport.Message:SetTextColor(0, 1, 1)
    ConditionerAddOn.LoadoutFrame.ImportExport.Message:SetPoint(
        "BOTTOM",
        ConditionerAddOn.LoadoutFrame.ImportExport,
        "TOP"
    )
    ...
    ConditionerAddOn.LoadoutFrame.InputName.Background =
        CreateFrame("Frame", nil, ConditionerAddOn.LoadoutFrame.InputName)
    ConditionerAddOn.LoadoutFrame.InputName.Background:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.LoadoutFrame.InputName,
        "TOPLEFT",
        -16,
    ...
    ConditionerAddOn.LoadoutFrame.SpecializationInfo.Texture:SetAllPoints(
        ConditionerAddOn.LoadoutFrame.SpecializationInfo
    )
    ...
    ConditionerAddOn.LoadoutFrame.SpecializationInfo:SetPoint(
        "TOPLEFT",
    ...
    ConditionerAddOn.LoadoutFrame.DropDown =
        CreateFrame(
        "Frame",
        "ConditionerLoadOutDropDown",
        ConditionerAddOn.LoadoutFrame,
        "ConditionerUIDropDownMenuTemplate"
    )
    ConditionerAddOn.LoadoutFrame.SpecializationInfo.SpecName:SetPoint(
        "BOTTOM",
        ConditionerAddOn.LoadoutFrame.DropDown,
        "TOP"
    )
    ConditionerAddOn.LoadoutFrame.DropDown:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.LoadoutFrame.SpecializationInfo,
        "RIGHT"
    )
    ConditionerAddOn.LoadoutFrame.DropDown.Choices = ConditionerAddOn_SavedVariables_Loadouts
    ConditionerAddOn.LoadoutFrame.DropDown.text =
        ConditionerAddOn.LoadoutFrame.DropDown:CreateFontString(nil, "OVERLAY", "SystemFont_NamePlateCastBar")
    ConditionerAddOn.LoadoutFrame.DropDown.text:SetPoint(
        "BOTTOM",
        ConditionerAddOn.LoadoutFrame.DropDown,
        "TOP",
        0,
    ...
    ConditionerAddOn.LoadoutFrame.DropDown.text:SetSize(
        ConditionerAddOn.LoadoutFrame.DropDown.text:GetStringWidth(),
    ...
    ConditionerAddOn.LoadoutFrame.DropDown:SetScript(
        "OnShow",
        function(self)
            ...
            if
                (not ConditionerAddOn.LoadoutFrame.DropDown.Choices[ConditionerAddOn.LoadoutFrame.DropDown.CurrentChoice]) or
    ...
    --CREATE LOADOUT
    ConditionerAddOn.LoadoutFrame.SaveLoadout =
        CreateFrame("Button", nil, ConditionerAddOn.LoadoutFrame, "ConditionerButtonTemplate")
    ConditionerAddOn.LoadoutFrame.SaveLoadout:SetText("Create New Loadout")
    ConditionerAddOn.LoadoutFrame.SaveLoadout:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.LoadoutFrame.SpecializationInfo,
        "BOTTOMLEFT",
        0,
    ...
    ConditionerAddOn.LoadoutFrame.SaveLoadout:SetScript(
        "OnClick",
        function(self, button, down)
            PlaySound(1115)
    ...
    ConditionerAddOn.LoadoutFrame.OverWrite =
        CreateFrame("Button", nil, ConditionerAddOn.LoadoutFrame, "ConditionerButtonTemplate")
    ConditionerAddOn.LoadoutFrame.OverWrite:SetText("Save")
    ...
    ConditionerAddOn.LoadoutFrame.OverWrite:SetScript(
        "OnClick",
        function(self, button, down)
            PlaySound(1115)
            if (ConditionerAddOn.LoadoutFrame.DropDown.CurrentChoice > 0) then
    ...
    --TRASH
    ConditionerAddOn.LoadoutFrame.TrashCan =
        CreateFrame("Button", nil, ConditionerAddOn.LoadoutFrame, "ConditionerButtonTemplate")
    ...
    ConditionerAddOn.LoadoutFrame.TrashCan:SetScript(
        "OnClick",
        function(self, button, down)
            PlaySound(1202)
    ...
    ConditionerAddOn.LoadoutFrame.ImportLoadout =
        CreateFrame("Button", nil, ConditionerAddOn.LoadoutFrame, "ConditionerButtonTemplate")
    ConditionerAddOn.LoadoutFrame.ImportLoadout:SetText("Import Loadout")
    ConditionerAddOn.LoadoutFrame.ImportLoadout:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.LoadoutFrame.SaveLoadout,
        "BOTTOMLEFT"
    )
    ConditionerAddOn.LoadoutFrame.ImportLoadout:SetSize(
        ConditionerAddOn.LoadoutFrame.SaveLoadout:GetWidth(),
        ConditionerAddOn.LoadoutFrame.SaveLoadout:GetHeight()
    )
    ConditionerAddOn.LoadoutFrame.ImportLoadout:SetScript(
        "OnClick",
        function(self, button, down)
            PlaySound(1115)
    ...
    --export loadout
    ConditionerAddOn.LoadoutFrame.ExportLoadout =
        CreateFrame("Button", nil, ConditionerAddOn.LoadoutFrame, "ConditionerButtonTemplate")
    ConditionerAddOn.LoadoutFrame.ExportLoadout:SetText("Export Loadout")
    ConditionerAddOn.LoadoutFrame.ExportLoadout:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.LoadoutFrame.ImportLoadout,
        "BOTTOMLEFT"
    )
    ConditionerAddOn.LoadoutFrame.ExportLoadout:SetSize(
        ConditionerAddOn.LoadoutFrame.SaveLoadout:GetWidth(),
        ConditionerAddOn.LoadoutFrame.SaveLoadout:GetHeight()
    )
    ConditionerAddOn.LoadoutFrame.ExportLoadout:SetScript(
        "OnClick",
        function(self, button, down)
            PlaySound(1115)
    ...
    ConditionerAddOn.LoadoutFrame.BackgroundFrame.Signature:SetPoint(
        "TOPRIGHT",
    ...
    ConditionerAddOn.LoadoutFrame.BackgroundFrame.Title:SetPoint(
        "BOTTOMLEFT",
        ConditionerAddOn.LoadoutFrame.BackgroundFrame,
        "TOPLEFT"
    )
    ...
    --NUM TRACKER FRAMES
    ConditionerAddOn.LoadoutFrame.NumTrackedFrames =
        ConditionerAddOn:NewSlider(
        ConditionerAddOn.LoadoutFrame,
        "ConditionerNumTrackedFrames",
        "1",
        "10",
        1,
        10,
    ...
    ConditionerAddOn.LoadoutFrame.NumTrackedFrames:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.LoadoutFrame.ExportLoadout,
        "BOTTOMLEFT",
        5,
    ...
    --TAPER SIZE
    ConditionerAddOn.LoadoutFrame.TaperSize =
        ConditionerAddOn:NewSlider(
        ConditionerAddOn.LoadoutFrame,
        "ConditionerTaperSize",
        "25%",
        "100%",
        25,
        100,
    ...
    ConditionerAddOn.LoadoutFrame.TaperSize:SetPoint(
        "TOP",
        ConditionerAddOn.LoadoutFrame.NumTrackedFrames,
        "BOTTOM",
        0,
    ...
    ConditionerAddOn.LoadoutFrame.AlwaysShow.text =
        ConditionerAddOn.LoadoutFrame.AlwaysShow:CreateFontString(nil, "OVERLAY")
    ...
    ConditionerAddOn.LoadoutFrame.AlwaysShow:SetPoint(
        "LEFT",
        ConditionerAddOn.LoadoutFrame.NumTrackedFrames,
        "RIGHT",
        16,
    ...
    ConditionerAddOn.LoadoutFrame.AlwaysShow:SetScript(
        "OnEnter",
        function(self)
            GameTooltip:SetOwner(self, "ANCHOR_RIGHT", 0, 0)
    ...
    --SWING TIMERS
    ConditionerAddOn.LoadoutFrame.ShowSwingTimers =
        CreateFrame("CheckButton", nil, ConditionerAddOn.LoadoutFrame, "UICheckButtonTemplate")
    ConditionerAddOn.LoadoutFrame.ShowSwingTimers.text =
        ConditionerAddOn.LoadoutFrame.ShowSwingTimers:CreateFontString(nil, "OVERLAY")
    ...
    ConditionerAddOn.LoadoutFrame.ShowSwingTimers.text:SetPoint(
        "LEFT",
        ConditionerAddOn.LoadoutFrame.ShowSwingTimers,
        "RIGHT"
    )
    ConditionerAddOn.LoadoutFrame.ShowSwingTimers:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.LoadoutFrame.AlwaysShow,
        "BOTTOMLEFT",
        0,
    ...
    ConditionerAddOn.LoadoutFrame.ShowSwingTimers:SetScript(
        "OnEnter",
        function(self)
            GameTooltip:SetOwner(self, "ANCHOR_RIGHT", 0, 0)
    ...
    --show cast bar
    ConditionerAddOn.LoadoutFrame.ShowTargetCastBar =
        CreateFrame("CheckButton", nil, ConditionerAddOn.LoadoutFrame, "UICheckButtonTemplate")
    ...
    ConditionerAddOn.LoadoutFrame.ShowTargetCastBar.text:SetPoint(
        "LEFT",
        ConditionerAddOn.LoadoutFrame.ShowTargetCastBar,
        "RIGHT"
    )
    ConditionerAddOn.LoadoutFrame.ShowTargetCastBar:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.LoadoutFrame.ShowSwingTimers,
        "BOTTOMLEFT",
        0,
    ...
    ConditionerAddOn.LoadoutFrame.ShowTargetCastBar:SetScript(
        "OnEnter",
        function(self)
            GameTooltip:SetOwner(self, "ANCHOR_RIGHT", 0, 0)
    ...
    ConditionerAddOn.LoadoutFrame.OptionsContainer:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.LoadoutFrame.AlwaysShow,
        "TOPLEFT"
    )
    ...
    ConditionerAddOn.LoadoutFrame.DancingManShoes =
        CreateFrame("Frame", nil, ConditionerAddOn.LoadoutFrame.BackgroundFrame)
    ConditionerAddOn.LoadoutFrame.DancingManShoes:SetPoint(
        "TOPLEFT",
        ConditionerAddOn.LoadoutFrame.BackgroundFrame,
        "TOPLEFT"
    )
    ConditionerAddOn.LoadoutFrame.DancingManShoes:SetSize(ConditionerAddOn.LoadoutFrame.BackgroundFrame:GetWidth(), 10)
    ConditionerAddOn.LoadoutFrame.DancingMan =
        CreateFrame("PlayerModel", nil, ConditionerAddOn.LoadoutFrame.BackgroundFrame)
    ...
    if (UnitFactionGroup("player") == "Alliance") then
        ...
        ConditionerAddOn.LoadoutFrame.DancingMan:SetPoint(
            "BOTTOMRIGHT",
            ConditionerAddOn.LoadoutFrame.DancingManShoes,
            "TOPRIGHT",
            20,
    ...
    ConditionerAddOn.LoadoutFrame.DancingManShoes:SetScript(
        "OnUpdate",
        function(self, elapsed)
            if
                (ConditionerAddOn.LoadoutFrame.DancingMan.Wounds) and
             ...
             then
                ...
                if (ConditionerAddOn.LoadoutFrame.DancingMan.isDead) then
                    ...
                    local percentFade =
                        math.max(
                        (ConditionerAddOn.LoadoutFrame.DancingMan.Wounds -
                            elapsed * ConditionerAddOn.LoadoutFrame.DancingMan.Acceleration) /
                            10,
                        0
                    )
                ...
                if
                 ...
                 then
                    ...
                    ConditionerAddOn.LoadoutFrame.DancingMan:SetRotation(
                        0.85 * (ConditionerAddOn.LoadoutFrame.DancingManShoes.Direction and 1 or -1)
                    )
                    ...
                    if (ConditionerAddOn.LoadoutFrame.DancingManShoes.isWalking) then
                        ...
                        ConditionerAddOn.LoadoutFrame.DancingMan:SetRotation(
                            0.25 * (ConditionerAddOn.LoadoutFrame.DancingManShoes.Direction and 1 or -1)
                        )
                    end
                ...
                if (ConditionerAddOn.LoadoutFrame.DancingManShoes.Timer >= 0) then
                    local deltaX =
                        (ConditionerAddOn.LoadoutFrame.BackgroundFrame:GetWidth() - 60) /
                        ConditionerAddOn.LoadoutFrame.DancingManShoes.RandomTimer
                    ConditionerAddOn.LoadoutFrame.DancingManShoes:SetWidth(
                        ConditionerAddOn.LoadoutFrame.DancingManShoes:GetWidth() +
    ...
    ConditionerAddOn.LoadoutFrame.DancingMan:SetScript(
        "OnAnimFinished",
        function(self)
            if (ConditionerAddOn.LoadoutFrame.DancingMan:IsShown()) then
                if
                    (ConditionerAddOn.LoadoutFrame.DancingMan.AnimQueue) and
                        (#ConditionerAddOn.LoadoutFrame.DancingMan.AnimQueue > 0)
                 then
                    local nextAnim =
    ...
    ConditionerAddOn.LoadoutFrame.DancingMan.Hitbox:SetPoint(
        "CENTER",
        ConditionerAddOn.LoadoutFrame.DancingMan,
        "CENTER"
    )
    ...
    ConditionerAddOn.LoadoutFrame.DancingMan.Hitbox:EnableMouse(true)
    ConditionerAddOn.LoadoutFrame.DancingMan.Hitbox:SetScript(
        "OnMouseDown",
        function(self, button, down)
...
function ConditionerAddOn.EventHandler:ADDON_LOADED(...)
    ...
    if (AddOnName == "Conditioner") then
        ...
        ConditionerAddOn_SavedVariables.Options =
            ConditionerAddOn_SavedVariables.Options or
            {
